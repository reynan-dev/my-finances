<template >
    <div class="space-y-3">
        <div class="px-5 py-6 bg-white rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div class="flex items-center space-x-4 ml-auto">
                    <div class="flex items-center">
                        ...
                        <svg v-if="transaction.amount > 0" class="w-4 h-4 text-green-600" fill="none"
                    ...
                    <button @click="isUpdatting = !isUpdatting">
            ...
            <transaction-edit-vue v-if="isUpdatting" :transaction="transaction" @cancel="isUpdatting = false"
                @update="onUpdate" />
...
<script>
import TransactionEditVue from './TransactionEdit.vue'
